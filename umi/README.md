...
# Решение ошибок
1.  [Ошибка по БД при обновлении - не существует таблица cms3_object_files](errors/cms3_object_files.md)
2.  [Ошибка по БД при удалении поддомена с документацией - databaseExeption FOREIGN KEY](errors/databaseExeption_FOREIGN_KEY.md)
# Решения
